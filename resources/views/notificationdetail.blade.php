...
<div class="content">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title">New Business Request</h4>
        </div>
    </div>
    <form>
        <div class="card-box">
        ...
        <div class="card-box">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br>
                    <button class="btn btn-danger submit-btn w-25" style="float:right;">Deny</button>
                    <button class="btn btn-success submit-btn w-25 mr-1" style="float:right;">Accept</button>                    
                </div>
            </div>
        </div>
    </form>
